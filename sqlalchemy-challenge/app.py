...
def homepage():
    ...
    return (
        ...
        f"<br/>"
        f"Temperature of the Most-Active Station for One Year:<br/>"
        f"/api/v1.0/tobs<br/>"
        f"<br/>"
        f"The Average, Maximum, and Minimum Temperature for a specified Start Date:<br/>"
        f"/api/v1.0/<start><br/>"
        f"<br/>"
        f"The Average, Maximum, and Minimum Temperatures for a specified Start and End Date:<br/>"
